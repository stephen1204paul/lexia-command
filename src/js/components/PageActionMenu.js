...
function PageActionMenu({ page, closeCommandBar, onBack }) {
    ...
    const actions = [
        {
            id: 'view',
            title: page.status === 'publish' ? __('View Page', 'lexia-command') : __('Preview Page', 'lexia-command'),
            icon: '👁️',
            action: () => {
        ...
        {
            id: 'edit',
            title: __('Edit Page', 'lexia-command'),
            icon: '✏️',
            action: () => {
